...
import { t as require_is_electron } from "./is-electron.mjs";
...
var require_loadImage = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var fs = __require("fs");
	var fetch = (init_lib(), __toCommonJS(lib_exports));
	...
	*/
	module.exports = async (image) => {
		...
		if (typeof image === "string") {
			if (isURL(image) || image.startsWith("moz-extension://") || image.startsWith("chrome-extension://") || image.startsWith("file://")) data = await (await fetch(image)).arrayBuffer();
